...
(function($) {
	...
	window.flashgallery_id = window.flashgallery_id || 1;
	...
	$.flashgallery = $.flashgallery || function(swf_url, config_url, options) {
		...
		swfobject.embedSWF(swf_url, element_id, options.width, options.height, '10.1.102.64', 'http://swfobject.googlecode.com/svn/trunk/swfobject/expressInstall.swf', { configPath: config_url }, params, attributes, function(e) {
			if (!e.success) {
				$.ajax({
					url: config_url,
					dataType: 'json',
